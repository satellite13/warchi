...
## Связанная пользовательская документация

- **Возможности интерфейса** (версии, карточки, диалоги): см. [user-interface-features.md](./user-interface-features.md) — описание дерева версий, стопки карточек при нескольких версиях, закрытия диалогов по Escape и др. Может использоваться как источник для вики и справки пользователей.
