...
assert_contains "${TMP_DIR}/arepos.yaml" 'image: "arch/arepos-server:0.5.3"'
arepos_resources="$(
  awk '
...
assert_contains "${TMP_DIR}/warchi.yaml" 'image: "arch/warchi:0.8.16"'
...
assert_contains "${TMP_DIR}/site.yaml" 'image: "arch/warchi-site:0.2.4"'
...
assert_contains "${TMP_DIR}/dry-run.out" 'Deploy arepos-server 0.5.3'
assert_contains "${TMP_DIR}/dry-run.out" 'Deploy warchi 0.8.16'
