...
assert_contains "${TMP_DIR}/warchi.yaml" 'image: "arch/warchi:0.8.14"'
...
assert_contains "${TMP_DIR}/site.yaml" 'image: "arch/warchi-site:0.2.2"'
...
assert_contains "${TMP_DIR}/dry-run.out" 'Deploy warchi 0.8.14'
assert_contains "${TMP_DIR}/dry-run.out" 'Deploy warchi-site 0.2.2'
