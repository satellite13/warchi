...
(function () {
  ...
  var STRINGS = {
    ru: {
      ...
      termC1: '# PostgreSQL + MinIO + сервер',
      termC2: '# открыть wArchi',
      termC3: '# REST API',
      termC4: '# Опционально: VITE_MODEL_LIVE_SYNC_MODE=hybrid в .env.local клиента',
    ...
    en: {
      ...
      termC1: '# PostgreSQL + MinIO + server',
      termC2: '# open wArchi',
      termC3: '# REST API',
      termC4: '# Optional: VITE_MODEL_LIVE_SYNC_MODE=hybrid in client .env.local',
    ...
    fr: {
      ...
      termC1: '# PostgreSQL + MinIO + serveur',
      termC2: '# ouvrir wArchi',
      termC3: '# API REST',
      termC4: '# Option : VITE_MODEL_LIVE_SYNC_MODE=hybrid dans .env.local du client',
