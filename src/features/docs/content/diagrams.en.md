...
3. In the dialog, choose the link type:
   ...
   - **Always latest version by name** — the link will show the latest saved version of the diagram with this name (the image updates after you save). **Renaming the diagram breaks this link.**
