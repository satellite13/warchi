...
export const validationScriptApiCatalog: ValidationScriptApiCatalogItem[] = [
  ...
  },
  {
    label: 'linksBetween',
    type: 'function',
    detail: 'async (a, b, options?)',
    info: 'Query model links between two nodes (both directions); optional linkType filter.',
  },
  {
    label: 'neighbors',
    type: 'function',
    detail: 'async (nodeId, { direction, linkType?, page? })',
    info: 'Paged graph neighbors from the model. Returns { items, last }.',
  },
  {
    label: 'searchNodes',
    type: 'function',
    detail: 'async ({ q?, type?, limit? })',
    info: 'Search model nodes. Requires q or type. Limit is capped at 50.',
  },
  {
    label: 'apply',
    type: 'namespace',
    detail: 'Command queue',
    info: 'Queue canvas commands. Nothing is written until the user applies the preview.',
  },
  {
    label: 'setBounds',
    type: 'method',
    parent: 'apply',
    detail: '({ instanceId, x, y, width?, height? })',
  },
  {
    label: 'addInstance',
    type: 'method',
  ...
  },
  {
    ...
    type: 'method',
    parent: 'apply',
    detail: '({ edgeInstanceId })',
  },
  {
    label: 'align',
    type: 'method',
    parent: 'apply',
    detail: '({ instanceIds, mode })',
  },
  {
    label: 'distribute',
    type: 'method',
    parent: 'apply',
    detail: '({ instanceIds, axis })',
  },
  {
    label: 'stack',
    type: 'method',
